...
class AssetService:
    ...
    @classmethod
    def list_employee_assignments(cls, **kwargs):
        from apps.assets.services.asset_assignment_service import AssetAssignmentService

        return AssetAssignmentService.list_employee_assignments(**kwargs)

    @classmethod
    def list_available_assets(cls, **kwargs):
        from apps.assets.services.asset_assignment_service import AssetAssignmentService

        return AssetAssignmentService.list_available_assets(**kwargs)

    @classmethod
    def assign_asset(cls, **kwargs):
        from apps.assets.services.asset_assignment_service import AssetAssignmentService

        return AssetAssignmentService.assign_asset(**kwargs)

    @classmethod
    def revoke_assignment(cls, **kwargs):
        from apps.assets.services.asset_assignment_service import AssetAssignmentService

        return AssetAssignmentService.revoke_assignment(**kwargs)

    @classmethod
    def serialize_assignment(cls, row):
        from apps.assets.services.asset_assignment_service import AssetAssignmentService

        return AssetAssignmentService.serialize_assignment(row)
