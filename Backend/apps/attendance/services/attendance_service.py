...
class AttendanceService:
    ...
    @classmethod
    def list_approvals_inbox(cls, **kwargs):
        from apps.attendance.services.attendance_approval_service import AttendanceApprovalService

        return AttendanceApprovalService.list_approvals_inbox(**kwargs)

    @classmethod
    def review_attendance(cls, **kwargs):
        from apps.attendance.services.attendance_approval_service import AttendanceApprovalService

        return AttendanceApprovalService.review_attendance(**kwargs)
